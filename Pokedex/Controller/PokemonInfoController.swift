...
//  Pokedex
//
//  Created by Engkit Satia Riswara on 01/03/19.
...
class PokemonInfoController: UIViewController {
        ...
        didSet {
            ...
            if let evoArray = pokemon?.evoArray {
                ...
                if evoArray.count > 1 {
                    ...
                    firstEvoImageView.image = evoArray.first?.image
    ...
    func configureViewComponents() {
        ...
        firstEvoImageView.anchor(top: evolutionView.bottomAnchor, left: view.leftAnchor, bottom: nil, right: nil, paddingTop: 32, paddingLeft: 32, paddingBottom: 0, paddingRight: 16, width: 120, height: 120)
        
        view.addSubview(secondEvoImageView)
        secondEvoImageView.anchor(top: evolutionView.bottomAnchor, left: nil, bottom: nil, right: view.rightAnchor, paddingTop: 32, paddingLeft: 16, paddingBottom: 0, paddingRight: 32, width: 120, height: 120)
